...
/* harmony import */ var _forgot_password_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./forgot-password.page */ "./src/app/pages/auth/forgot-password/forgot-password.page.ts");
...
/* harmony import */ var _forgot_password_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./forgot-password-routing.module */ "./src/app/pages/auth/forgot-password/forgot-password-routing.module.ts");
...
let ForgotPasswordPage = class ForgotPasswordPage {
    constructor(formBuilder, _apiService, alertCtrl) {
    ...
    forgotPassword(data) {
        ...
        this._apiService.postRequest(this.url + _config_config__WEBPACK_IMPORTED_MODULE_5__["URL"].forgotPassword, params).subscribe((res) => {
            if (res.success) {
