...
/* harmony import */ var _place_detail_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./place-detail.page */ "./src/app/pages/tanent/place-detail/place-detail.page.ts");
...
PlaceDetailPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
/* harmony import */ var _place_detail_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./place-detail-routing.module */ "./src/app/pages/tanent/place-detail/place-detail-routing.module.ts");
/* harmony import */ var _place_detail_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./place-detail.page */ "./src/app/pages/tanent/place-detail/place-detail.page.ts");
...
/* harmony import */ var src_app_utilities_mainfunction__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/utilities/mainfunction */ "./src/app/utilities/mainfunction.ts");
/* harmony import */ var _start_booking_start_booking_page__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../start-booking/start-booking.page */ "./src/app/pages/tanent/start-booking/start-booking.page.ts");
/* harmony import */ var src_app_services_global_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/services/global.service */ "./src/app/services/global.service.ts");
/* harmony import */ var src_app_rating_rating_page__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/rating/rating.page */ "./src/app/rating/rating.page.ts");
...
let PlaceDetailPage = class PlaceDetailPage {
    ...
    // validateChip: any;
    // doValidate: any;
    constructor(route, router, modalCtrl, loader, _api, storage, _gs) {
        this.route = route;
        this.router = router;
            ...
            if (params && params.special) {
                ...
                if (this.data.videos && this.data.videos.length) {
                    this.data.videos.map((x) => {
                        let id = Object(src_app_utilities_mainfunction__WEBPACK_IMPORTED_MODULE_8__["getEmbedUrl"])(x.url);
    ...
    getTimings() {
        if (this.token) {
            ...
            this._api.postRequest(this.url + _config_config__WEBPACK_IMPORTED_MODULE_6__["UNITURL"].getBookingDates, params).subscribe((result) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                this.loader.dismiss();
                if (result.success) {
    ...
    getReviews() {
        ...
        this._api.postRequest(url + _config_config__WEBPACK_IMPORTED_MODULE_6__["URL"].reviews, params).subscribe((result) => {
            console.log(result);
            if (result.success) {
                if (result.data) {
...
PlaceDetailPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./place-detail.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/tanent/place-detail/place-detail.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./place-detail.page.scss */ "./src/app/pages/tanent/place-detail/place-detail.page.scss")).default]
    })
], PlaceDetailPage);
...
//# sourceMappingURL=pages-tanent-place-detail-place-detail-module-es2015.js.map