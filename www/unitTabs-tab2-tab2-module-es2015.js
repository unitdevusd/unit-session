...
/* harmony import */ var _tab2_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./tab2.page */ "./src/app/pages/unitTabs/tab2/tab2.page.ts");
...
/* harmony import */ var _tab2_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./tab2.page */ "./src/app/pages/unitTabs/tab2/tab2.page.ts");
/* harmony import */ var _tab2_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./tab2-routing.module */ "./src/app/pages/unitTabs/tab2/tab2-routing.module.ts");
...
/* harmony import */ var src_app_utilities_mainfunction__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/utilities/mainfunction */ "./src/app/utilities/mainfunction.ts");
...
let Tab2Page = class Tab2Page {
    constructor(router, _apiService, _loader, _gs, storage, _toast) {
        this.router = router;
    ...
    getMyStays() {
        ...
        if (this.token && this.orgId) {
            ...
            console.log(params);
            this._apiService.postRequest(this.url + _config_config__WEBPACK_IMPORTED_MODULE_6__["UNITURL"].mybookings, params).subscribe((result) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                console.log(result);
                if (result.success) {
    ...
    segmentChanged(ev) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            yield this.selectedSlider.slideTo(this.segment);
        });
    }
    slideChanged(slider) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
    ...
    navigateToPayment(place) {
        let newStartDate = moment__WEBPACK_IMPORTED_MODULE_10__(place.startDate).format('YYYY-MM-DD');
        let newEndDate = moment__WEBPACK_IMPORTED_MODULE_10__(place.endDate).format('YYYY-MM-DD');
        let noOfDays = Object(src_app_utilities_mainfunction__WEBPACK_IMPORTED_MODULE_9__["getDays"])(newStartDate, newEndDate);
    ...
    navigateToDetails(place, tabType) {
        let navigationExtras = {
            queryParams: {
                type: "Owner",
                tabType: tabType
...
Tab2Page = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-tab2',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./tab2.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/unitTabs/tab2/tab2.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./tab2.page.scss */ "./src/app/pages/unitTabs/tab2/tab2.page.scss")).default]
    })
], Tab2Page);
...
//# sourceMappingURL=unitTabs-tab2-tab2-module-es2015.js.map