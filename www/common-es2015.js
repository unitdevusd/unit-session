...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StartBookingPage", function() { return StartBookingPage; });
...
let StartBookingPage = class StartBookingPage {
    constructor(route, router, navParams, modalCtrl, toast) {
        this.route = route;
        this.router = router;
...
StartBookingPage.ctorParameters = () => [
...
StartBookingPage.propDecorators = {
    placeInfo: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }],
    editInfo: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }],
    dates: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }]
};
StartBookingPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-start-booking',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./start-booking.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/tanent/start-booking/start-booking.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./start-booking.page.scss */ "./src/app/pages/tanent/start-booking/start-booking.page.scss")).default]
    })
], StartBookingPage);
...
let RatingPage = class RatingPage {
    constructor(modalCtrl, loaderCtrl, platform) {
        this.modalCtrl = modalCtrl;
...
RatingPage.propDecorators = {
    unitId: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }],
    unitName: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"] }]
};
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getEmbedUrl", function() { return getEmbedUrl; });
