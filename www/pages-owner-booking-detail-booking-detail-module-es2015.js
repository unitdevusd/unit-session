...
/* harmony import */ var _booking_detail_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./booking-detail.page */ "./src/app/pages/owner/booking-detail/booking-detail.page.ts");
...
/* harmony import */ var _booking_detail_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./booking-detail-routing.module */ "./src/app/pages/owner/booking-detail/booking-detail-routing.module.ts");
/* harmony import */ var _booking_detail_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./booking-detail.page */ "./src/app/pages/owner/booking-detail/booking-detail.page.ts");
...
let BookingDetailPage = class BookingDetailPage {
    constructor(route, router, _api, alert, refresh, alrtCtrl, loader, storage, navController, _gs) {
        this.route = route;
        this.router = router;
        this._api = _api;
        this.alert = alert;
    ...
    placeMeta() {
        ...
        this._api.postRequest(this.url + _config_config__WEBPACK_IMPORTED_MODULE_8__["UNITURL"].placeMeta, params).subscribe((result) => {
            if (result.success) {
    ...
    getBookingDetails() {
        ...
        console.log(params);
        this._api.postRequest(this.url + _config_config__WEBPACK_IMPORTED_MODULE_8__["UNITURL"].bookingDetails, params).subscribe((result) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            console.log(result);
            if (result.success) {
    ...
    cancelBooking() {
        if (this.token) {
            ...
            console.log(params);
            this._api.postRequest(this.url + _config_config__WEBPACK_IMPORTED_MODULE_8__["UNITURL"].cancelBooking, params).subscribe((result) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                if (result.success) {
    ...
    checkin(url) {
        if (this.token) {
            ...
            console.log(params);
            this._api.postRequest(this.url + url, params).subscribe((result) => Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
                if (result.success) {
                    this.refresh.refreshMyStays("refresh");
                    this.alert.presentToast(result.message);
                }
...
BookingDetailPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./booking-detail.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/owner/booking-detail/booking-detail.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./booking-detail.page.scss */ "./src/app/pages/owner/booking-detail/booking-detail.page.scss")).default]
    })
], BookingDetailPage);
...
//# sourceMappingURL=pages-owner-booking-detail-booking-detail-module-es2015.js.map